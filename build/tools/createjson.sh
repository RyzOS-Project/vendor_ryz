...
existingOTAjson=./ryz/OTA/builds/$1.json
output=$2/$1.json
  ...
  "response": [
    {
      ...
      "device": "'$device'",
      "filename": "'$filename'",
      "download": "https://sourceforge.net/projects/RyzOS/files/'$1'/
15/'$3'/download",
      "timestamp": '$timestamp',
      "md5": "'$md5'",
      "sha256": "'$sha256'",
  ...
  "response": [
    {
      ...
      "device": "''",
      "filename": "'$filename'",
      "download": "https://sourceforge.net/projects/RyzOS/files/'$1'/15/'$3'/download",
      "timestamp": '$timestamp',
      "md5": "'$md5'",
      "sha256": "'$sha256'",
      "size": '$size',
