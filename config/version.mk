...
# Internal version
LINEAGE_VERSION := RyzOS-$(RYZ_MOD_VERSION)-$(RYZ_VER)-$(LINEAGE_BUILD)-$(RYZ_BUILD_VARIANT)-$(RYZ_BUILD_TYPE)-$(shell date +%Y%m%d)
...
ifeq ($(WITH_GMS),true)
RYZ_BUILD_VARIANT := GAPPS
else
RYZ_BUILD_VARIANT := VANILLA
